...
class students
{
  ...
  public:
    void getdata(char *n, int r, float *m);
    void display();
...
void students :: getdata(char *n, int r, float *m)
{
...
int main()
{
    ...
    for (int i_243 = 0; i_243 < n_243; i_243++)
    {
        ...
        ob_243[i_243].getdata(name,roll,marks);
    }
    cout << "Details:"<<endl;
    cout << "Name"<<"\t"<<"Roll" <<"\t\t"<<"Average Marks"<<endl;
    for (int i_243 = 0; i_243 < n_243; i_243++)
    {
        ob_243[i_243].display();
    }
    AvgClass(ob_243,n_243);
